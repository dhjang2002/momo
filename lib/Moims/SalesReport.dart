...
// 검색기간
const List<String> _listSalesRange = [
  "ALL",
  "THIS_WEEK",
  "LAST_WEEK",
  "THIS_MONTH",
...
const List<String> _listMenuRange = [
  '전체',
  '이번주',
  '지난주',
  '이번달',
...
// 거래유형
const List<String> _listSalesKind = [
  "LIST_ALL",
  "LIST_SALES",
  "LIST_BUYS",
  "MY_SALES",
...
const List<String> _listMenuKind = [
  '거래현황',
  '판매현황',
  '구매현황',
  '내 판매현황',
...
class SalesReport extends StatefulWidget {
  ...
  const SalesReport({Key? key, required this.moims_id, required this.title})
      : super(key: key);
...
class _SalesReportState extends State<SalesReport> {
  ...
  String _selectedKind  = _listMenuKind[0];
  String _selectedRange = _listMenuRange[0];
          ...
          children: [
             Row(
                ...
                children: [
                  ...
                  Text(
                    currencyFormat(sumarry.count.toString()) + "건",
                    style: const TextStyle(
                        color: Colors.black,
                        fontWeight: FontWeight.bold,
                        fontSize: 16.0),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      currencyFormat(info.count.toString()),
                      style: const TextStyle(
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                          fontSize: 15.0),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      currencyFormat(info.total.toString()) + "원",
                      style: const TextStyle(
                          color: Colors.black,
                          fontWeight: FontWeight.bold,
                          fontSize: 15.0),
